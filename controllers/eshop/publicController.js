...
export const getProductsByShop = async (req, res) => {
    try {
      ...
      const { search, category, sortBy, page = 1, limit = 10 } = req.query; // Destructure query params
  
      // Build the search query object
      let query = { shopOwner: shopId, isActive: true };
      ...
      if (category) {
        // Assuming category is an ObjectId, convert if it's not
        query = { ...query, category: mongoose.Types.ObjectId(category) }; 
      }
